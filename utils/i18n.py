...
_CATALOG: dict[str, dict[str, str]] = {
    ...
    "welcome.default_leave": {
        "fr": "👋 {name} a quitté **{server}**. À bientôt !",
        "en": "👋 {name} left **{server}**. See you!",
    },
    "welcome.default_dm": {
        "fr": "👋 Bienvenue sur **{server}**, {name} ! Amuse-toi bien.",
        "en": "👋 Welcome to **{server}**, {name}! Enjoy your stay.",
    },
    "welcome.too_long": {
        "fr": "❌ Message trop long (max {max} caractères).",
        "en": "❌ Message too long (max {max} characters).",
    },
    "welcome.channel_set": {
        "fr": "✅ Salon de bienvenue/au revoir défini sur {channel}.",
        "en": "✅ Welcome/goodbye channel set to {channel}.",
    },
    "welcome.channel_off": {
        "fr": "✅ Messages de bienvenue/au revoir désactivés (aucun salon).",
        "en": "✅ Welcome/goodbye messages disabled (no channel).",
    },
    "welcome.join_set": {"fr": "✅ Message d'arrivée mis à jour.",
                         "en": "✅ Join message updated."},
    "welcome.join_reset": {"fr": "✅ Message d'arrivée remis par défaut.",
                           "en": "✅ Join message reset to default."},
    "welcome.leave_set": {"fr": "✅ Message de départ mis à jour.",
                          "en": "✅ Leave message updated."},
    "welcome.leave_reset": {"fr": "✅ Message de départ remis par défaut.",
                            "en": "✅ Leave message reset to default."},
    "welcome.dm_set": {"fr": "✅ Message du MP de bienvenue mis à jour.",
                       "en": "✅ Welcome DM message updated."},
    "welcome.dm_reset": {"fr": "✅ Message du MP de bienvenue remis par défaut.",
                         "en": "✅ Welcome DM message reset to default."},
    "welcome.dm_on": {"fr": "✅ MP de bienvenue **activé**.",
                      "en": "✅ Welcome DM **enabled**."},
    "welcome.dm_off": {"fr": "✅ MP de bienvenue **désactivé**.",
                       "en": "✅ Welcome DM **disabled**."},
    "welcome.cfg_title": {"fr": "⚙️ Configuration bienvenue",
                          "en": "⚙️ Welcome configuration"},
    "welcome.cfg_channel": {"fr": "Salon arrivée/départ", "en": "Join/leave channel"},
    "welcome.cfg_join": {"fr": "Message d'arrivée", "en": "Join message"},
    "welcome.cfg_leave": {"fr": "Message de départ", "en": "Leave message"},
    "welcome.cfg_dm": {"fr": "MP de bienvenue", "en": "Welcome DM"},
    "welcome.cfg_dm_msg": {"fr": "Message du MP", "en": "DM message"},
    "welcome.cfg_on": {"fr": "✅ activé", "en": "✅ enabled"},
    "welcome.cfg_off": {"fr": "❌ désactivé", "en": "❌ disabled"},
    "welcome.cfg_none": {"fr": "*(aucun)*", "en": "*(none)*"},
    "welcome.cfg_placeholders": {
        "fr": "Placeholders : {user} {name} {server} {count}",
        "en": "Placeholders: {user} {name} {server} {count}",
    },
    # --- Giveaway ---
    "gw.bad_duration": {
        "fr": "❌ Durée invalide. Exemples : `30m`, `2h`, `1d`, `1h30m`.",
        "en": "❌ Invalid duration. Examples: `30m`, `2h`, `1d`, `1h30m`.",
    },
    "gw.bad_winners": {
        "fr": "❌ Nombre de gagnants invalide (entre 1 et {max}).",
        "en": "❌ Invalid number of winners (between 1 and {max}).",
    },
    "gw.bad_id": {"fr": "❌ ID de message invalide.",
                  "en": "❌ Invalid message ID."},
    "gw.title": {"fr": "🎉 GIVEAWAY : {prize}", "en": "🎉 GIVEAWAY: {prize}"},
    "gw.desc": {
        "fr": "Réagis avec {emoji} pour participer !\nGagnant(s) : **{winners}**",
        "en": "React with {emoji} to enter!\nWinner(s): **{winners}**",
    },
    "gw.ends": {"fr": "Se termine", "en": "Ends"},
    "gw.host": {"fr": "Organisé par", "en": "Hosted by"},
    "gw.footer": {"fr": "Durée : {duration}", "en": "Duration: {duration}"},
    "gw.started": {"fr": "✅ Giveaway lancé : {link}",
                   "en": "✅ Giveaway started: {link}"},
    "gw.ended_desc": {"fr": "🎉 Giveaway terminé : **{prize}**",
                      "en": "🎉 Giveaway ended: **{prize}**"},
    "gw.winners_field": {"fr": "Gagnant(s)", "en": "Winner(s)"},
    "gw.no_participant": {
        "fr": "😢 Aucun participant, pas de gagnant.",
        "en": "😢 No participants, no winner.",
    },
    "gw.announce": {
        "fr": "🎉 Félicitations {winners} ! Vous gagnez **{prize}**.\n{link}",
        "en": "🎉 Congratulations {winners}! You win **{prize}**.\n{link}",
    },
    "gw.not_found": {"fr": "❌ Giveaway introuvable sur ce serveur.",
                     "en": "❌ Giveaway not found on this server."},
    "gw.already_ended": {"fr": "⚠️ Ce giveaway est déjà terminé.",
                         "en": "⚠️ This giveaway has already ended."},
    "gw.force_ended": {"fr": "✅ Giveaway terminé.", "en": "✅ Giveaway ended."},
    "gw.not_ended": {
        "fr": "⚠️ Ce giveaway n'est pas encore terminé (utilise `gend`).",
        "en": "⚠️ This giveaway hasn't ended yet (use `gend`).",
    },
    "gw.msg_gone": {"fr": "❌ Le message du giveaway est introuvable.",
                    "en": "❌ The giveaway message is missing."},
    "gw.reroll": {
        "fr": "🎉 Nouveau gagnant : {winner} remporte **{prize}** !",
        "en": "🎉 New winner: {winner} wins **{prize}**!",
    },
    # --- Owner : leave ---
    "leave.bad_id": {"fr": "❌ ID de serveur invalide.",
                     "en": "❌ Invalid server ID."},
    "leave.not_found": {"fr": "❌ Le bot n'est pas sur ce serveur.",
                        "en": "❌ The bot is not on that server."},
    "leave.failed": {"fr": "❌ Échec du départ : {error}",
                     "en": "❌ Failed to leave: {error}"},
    "leave.done": {"fr": "✅ Le bot a quitté **{name}** (`{id}`).",
                   "en": "✅ The bot left **{name}** (`{id}`)."},
    "leave.usage": {"fr": "Usage : `leave <id_serveur>`",
                    "en": "Usage: `leave <server_id>`"},
    # --- Owner : banserv (blacklist de serveurs) ---
    "banserv.bad_id": {"fr": "❌ ID de serveur invalide.",
                       "en": "❌ Invalid server ID."},
    "banserv.usage": {"fr": "Usage : `banserv <id_serveur>`",
                      "en": "Usage: `banserv <server_id>`"},
    "banserv.already": {"fr": "⚠️ Le serveur `{id}` est déjà blacklisté.",
                        "en": "⚠️ Server `{id}` is already blacklisted."},
    "banserv.added": {"fr": "✅ Serveur `{id}` ajouté à la blacklist.",
                      "en": "✅ Server `{id}` added to the blacklist."},
    "banserv.left": {"fr": "👋 Le bot était sur **{name}** : il l'a quitté.",
                     "en": "👋 The bot was on **{name}**: it has left."},
    "banserv.removed": {"fr": "✅ Serveur `{id}` retiré de la blacklist.",
                        "en": "✅ Server `{id}` removed from the blacklist."},
    "banserv.not_listed": {"fr": "⚠️ Le serveur `{id}` n'est pas blacklisté.",
                           "en": "⚠️ Server `{id}` is not blacklisted."},
    "banserv.list_empty": {"fr": "Aucun serveur blacklisté.",
                           "en": "No blacklisted servers."},
    "banserv.list": {"fr": "🚫 **{count}** serveur(s) blacklisté(s) :\n{ids}",
                     "en": "🚫 **{count}** blacklisted server(s):\n{ids}"},
    "banserv.dm_title": {"fr": "🚫 Serveur blacklisté",
                         "en": "🚫 Server blacklisted"},
    "banserv.dm_desc": {
        "fr": "Le serveur **{server}** est sur la blacklist du bot : je l'ai "
              "donc quitté. Si tu penses qu'il s'agit d'une erreur, rejoins "
              "le serveur de support ci-dessous.",
        "en": "The server **{server}** is on the bot's blacklist, so I have "
              "left it. If you think this is a mistake, join the support "
              "server below.",
    },
    "banserv.dm_support": {"fr": "Serveur de support", "en": "Support server"},
    "banserv.alert_title": {"fr": "🚫 Serveur blacklisté quitté",
                            "en": "🚫 Blacklisted server left"},
    "banserv.alert_join": {
        "fr": "Le bot a été invité sur un serveur blacklisté et l'a quitté.",
        "en": "The bot was invited to a blacklisted server and left it.",
    },
    "banserv.alert_manual": {
        "fr": "Un serveur a été blacklisté ; le bot y était et l'a quitté.",
        "en": "A server was blacklisted; the bot was on it and left.",
    },
    ...
    # Notifications aux owners : arrivée / départ d'un serveur.
    "gn.join_title": {"fr": "➕ Watcher a rejoint un serveur",
                      "en": "➕ Watcher joined a server"},
    "gn.leave_title": {"fr": "➖ Watcher a quitté un serveur",
                       "en": "➖ Watcher left a server"},
    "gn.name": {"fr": "Nom", "en": "Name"},
    "gn.total": {"fr": "Serveurs au total", "en": "Total servers"},
    "gn.members_val": {"fr": "**{count}** · 👤 {humans} · 🤖 {bots}",
                       "en": "**{count}** · 👤 {humans} · 🤖 {bots}"},
    ...
    # Notification de mise à jour (déploiement) aux owners.
    "upd.title": {"fr": "🚀 Watcher a été mis à jour",
                  "en": "🚀 Watcher has been updated"},
    "upd.version": {"fr": "Version", "en": "Version"},
    "upd.commit": {"fr": "Commit", "en": "Commit"},
    "upd.prs": {"fr": "Pull requests", "en": "Pull requests"},
    "upd.changes": {"fr": "Changements", "en": "Changes"},
    "upd.none": {"fr": "_(aucun détail)_", "en": "_(no details)_"},
    "upd.footer": {"fr": "Mise à jour appliquée et bot redémarré.",
                   "en": "Update applied and bot restarted."},
    ...
    "cat.owner_server": {"fr": "👑 Propriétaire de serveur",
                         "en": "👑 Server owner"},
    # Libellés des permissions Discord (source unique : help ET erreurs).
    "dperm.administrator": {"fr": "Administrateur", "en": "Administrator"},
    "dperm.manage_messages": {"fr": "Gérer les messages",
                              "en": "Manage Messages"},
    "dperm.manage_channels": {"fr": "Gérer les salons", "en": "Manage Channels"},
    "dperm.manage_roles": {"fr": "Gérer les rôles", "en": "Manage Roles"},
    "dperm.manage_guild": {"fr": "Gérer le serveur", "en": "Manage Server"},
    "dperm.kick_members": {"fr": "Expulser des membres", "en": "Kick Members"},
    "dperm.ban_members": {"fr": "Bannir des membres", "en": "Ban Members"},
    "dperm.moderate_members": {"fr": "Exclure des membres (timeout)",
                               "en": "Timeout Members"},
    "dperm.manage_nicknames": {"fr": "Gérer les pseudos",
                               "en": "Manage Nicknames"},
    "dperm.mention_everyone": {"fr": "Mentionner @everyone",
                               "en": "Mention @everyone"},
    ...
    "cmddesc.giveaway": {
        "fr": "Lance un giveaway (ex: giveaway 1h 1 Nitro).",
        "en": "Start a giveaway (e.g. giveaway 1h 1 Nitro)."},
    "cmddesc.gend": {
        "fr": "Termine immédiatement un giveaway (par ID de message).",
        "en": "End a giveaway immediately (by message ID)."},
    "cmddesc.greroll": {
        "fr": "Retire un nouveau gagnant d'un giveaway terminé.",
        "en": "Reroll a new winner for an ended giveaway."},
    ...
    "mod.dm_failed": {
        "fr": "⚠️ MP non délivré (l'utilisateur a peut-être fermé ses MP).",
        "en": "⚠️ DM not delivered (the user may have DMs disabled)."},
